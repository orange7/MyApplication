...
/**
 * Get an instance of {@link me.tatarka.rxloader.RxLoaderManager} that works
...
public final class RxLoaderManagerCompat {
	...
	/**
	 * Get an instance of {@code RxLoaderManager} that is tied to the lifecycle
	 * of the given {@link android.support.v4.app.FragmentActivity}.
	 * 
	 * @param activity
	 *            the activity
	...
	public static RxLoaderManager get(FragmentActivity activity) {
		RxLoaderBackendFragmentCompat fragment = (RxLoaderBackendFragmentCompat) activity
	...
	/**
	 * Get an instance of {@code RxLoaderManager} that is tied to the lifecycle
	 * of the given {@link android.support.v4.app.Fragment}.
	 * 
	 * @param fragment
	 *            the fragment
	 * @return the {@code RxLoaderManager}
	...
	public static RxLoaderManager get(Fragment fragment) {
		RxLoaderBackendFragmentCompat manager = (RxLoaderBackendFragmentCompat) fragment
